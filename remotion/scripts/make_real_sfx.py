"""Synthesise the promo's sound bed into public/real-sfx.wav (no external deps)."""
import math, random, struct, wave

SR, FPS, FRAMES = 44100, 30, 330
...
pad(0, 125, [55, 82.4, 110, 164.8], 0.03)
pad(122, 330, [49, 73.4, 98, 146.8, 185], 0.03)
whoosh(128, 0.9, 0.25)
impact(128, 0.3)
peak = max(abs(x) for x in buf) or 1
with wave.open('public/real-sfx.wav', 'wb') as w:
